 ...
 */
public class AbHttpClient_PUT_Test extends AbHttpClient_RequestDAO {
    public AbHttpClient_PUT_Test() {}
    ...
    public void test_AbHttpClient_SimplePUT() {
        System.out.println("---------test_AbHttpClient_SimplePUT");
        int expCode = 201;
        ...
        // Sending the post
        String result = instance.put(END_POINT);
     ...
     */
    @Test
    public void test_AbHttpClient_PUT_addCookies() {
        System.out.println("---------test_AbHttpClient_PUT_addCookies");
        int expCode = 201;
     ...
     */
    @Test
    public void test_AbHttpClient_PUT_Parameters() {
        System.out.println("---------test_AbHttpClient_SimplePUT");
        int expCode = 201;
        AbHttpClient instance = new AbHttpClient();
